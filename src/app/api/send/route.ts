            ...
            html: `
                <div style="font-family: Arial, sans-serif; padding: 20px; border: 1px solid #eee; border-radius: 8px; max-width: 600px; margin: auto;">
                    ...
                    <table style="width: 100%; font-size: 16px; color: #333;">
                        ...
                        <tr><td style="padding: 8px; font-weight: bold;">Phone (Dubai):</td><td style="padding: 8px;">${phone}</td></tr>
                        <tr><td style="padding: 8px; font-weight: bold;">Service Requested:</td><td style="padding: 8px;">${service}</td></tr>
                    </table>
